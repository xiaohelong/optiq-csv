...
class SolrEnumerator implements Enumerator<Object[]> {
  private final Iterator<SolrDocument> reader;
  ...
  public SolrEnumerator(Iterator<SolrDocument> document, SolrFieldType[] fieldTypes, List<String> fieldnames) {
    ...
    public SolrEnumerator(Iterator<SolrDocument> document, SolrFieldType[] fieldTypes) {
        this(document, fieldTypes, identityList(fieldTypes.length));
    }

  public SolrEnumerator(Iterator<SolrDocument> document, SolrFieldType[] fieldTypes, int[] fields) {
