...
public class SolrTableFactory implements TableFactory<SolrTable> {
    ...
    public SolrTable create(Schema schema, String name,
        ...
        final RelDataType rowType2 =
                SolrTable.deduceRowType(schema.getTypeFactory(), server, list);
        final RelDataType rowType3 = rowType != null ? rowType : rowType2;
        return new SolrTable(schema, name, res, rowType3, list);
    }
}